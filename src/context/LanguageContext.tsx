...
const translations = {
  en: {
    ...
    "supportTheProjectDescription": "Help us keep this project running and ad-free.",
    ...
    'language.detected': 'We\'ve set your language to {language} based on your location ({country}). You can change this anytime.',
     'movie.subtitle': 'Browse thousands of movies from all genres',
  ...
  es: {
    ...
    "supportTheProjectDescription":"Ayúdanos a mantener este proyecto funcionando y sin publicidad.",
    "donate" : "Dona via PayPal",
    ...
    'movie.subtitle': 'Explora miles de películas de todos los géneros.',
