...
export function XCloseIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
...
export const PayPalIcon = ({ className }: { className?: string }) => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M7.076 21.337H2.47a.641.641 0 0 1-.633-.74L4.944.901C5.026.382 5.474 0 5.998 0h7.46c2.57 0 4.578.543 5.69 1.81 1.01 1.15 1.304 2.42 1.012 4.287-.023.143-.047.288-.077.437-.983 5.05-4.349 6.797-8.647 6.797h-2.19c-.524 0-.968.382-1.05.9l-1.12 7.106zm1.18-13.191h2.19c3.824 0 6.624-1.557 7.49-5.411.23-1.05-.054-1.806-.733-2.370C16.266 1.718 15.39 1.5 14.264 1.5H8.756c-.524 0-.968.382-1.05.9L6.256 8.146z"/>
  </svg>
);
